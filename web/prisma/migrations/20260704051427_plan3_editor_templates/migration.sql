...
CREATE TABLE "Template" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Template_ownerUserId_fkey" FOREIGN KEY ("ownerUserId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Resume" (
    ...
    CONSTRAINT "Resume_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "RewriteSession" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
